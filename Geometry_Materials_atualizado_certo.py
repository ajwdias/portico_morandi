...
fy_normal_14mm = 538 #MPa        # estes tiene las barras de acero longitudinales
...
fy_normal_10mm = 529 #400MPa   # estes tiene las barras de acero longitudinales
...
fy_normal_22mm = 491 #462MPa   # estes tiene las barras de acero longitudinales
...
fc_normal = 34 #MPa   # 33.9 34.3 Infill Frame
...
b_beam = 0.35     # Width of the beam (m)
h_beam = 0.35      # Height of the beam (m)
cobrimento_beam = 0.04  # Cover of the steel bars (m)

diam_sup_beam_1 = 0.014
diam_mid_beam_1 = 0.010  # Diameter of the upper steel bars (m)
diam_inf_beam_1 = 0.014  # Diameter of the lower steel bars (m)
nbarras_sup_beam = 4
nbarras_mid_beam = 2    # Number of upper steel bars
nbarras_inf_beam = 4    # Number of lower steel bars
diam_transversal_beam = 0.005  # Diameter of the transverse steel bars (m)
espacamento_s_beam = 0.07  # Spacing of the transverse steel bars (m)


diam_longitudinal_value = [diam_sup_beam_1, diam_inf_beam_1, diam_mid_beam_1]
barras_camadas_value = [nbarras_sup_beam, nbarras_inf_beam, nbarras_mid_beam]
PosIniCam_value= [h_beam/2-cobrimento_beam, cobrimento_beam-h_beam/2, 0]
PosFinalCam_value = [h_beam/2-cobrimento_beam, cobrimento_beam-h_beam/2, 0]
...
IntegraTag,SectionTag,Ec,Ast,rho_cc,Ae,Acc,ke,rho_x,rho_y,flx,fly,A,B,fc_confinado,ec_confinado,xn,n,r,fc_uncon = sec_fibrasconfinadas(SectionTag = SectionTag_beam_1, IntegraTag = BeamIntegraTag_1 , ConcretoC_Tag = ConcretoC_Tag_beam1,ConcretoNC_Tag=ConcretoNC_Tag_beam1,Steel_Tag = [Material_Steel_14mm_Tag,Material_Steel_10mm_Tag], MinMaxSteel_Tag = [MinMaxTag_steel_14mm,MinMaxTag_steel_10mm] , numIntgrPts=numIntgrPts_extBeam, 
                b_beam=b_beam, h_beam=h_beam, fc = fc_normal_beam, cobrimento = cobrimento_beam, 
...
diam_sup_beam_3 = 0.014
diam_mid_beam_3 = 0.010
diam_inf_beam_3 = 0.014
nbarras_sup_beam = 4
nbarras_mid_beam = 2
nbarras_inf_beam = 4
diam_transversal_beam = 0.005
espacamento_s_beam_int = 0.2  

diam_longitudinal_value = [diam_sup_beam_3, diam_inf_beam_3, diam_mid_beam_3]
barras_camadas_value = [nbarras_sup_beam, nbarras_inf_beam, nbarras_mid_beam]
PosIniCam_value= [h_beam/2-cobrimento_beam, cobrimento_beam-h_beam/2, 0]
PosFinalCam_value = [h_beam/2-cobrimento_beam, cobrimento_beam-h_beam/2, 0]
...
diam_sup_beam_2 = 0.014
diam_mid_beam_2 = 0.010
diam_inf_beam_2 = 0.014
nbarras_sup_beam = 4
nbarras_mid_beam = 2
nbarras_inf_beam = 4
diam_transversal_beam = 0.005
espacamento_s_beam = 0.20


diam_longitudinal_value = [diam_sup_beam_2, diam_inf_beam_2, diam_mid_beam_2]
barras_camadas_value = [nbarras_sup_beam, nbarras_inf_beam, nbarras_mid_beam]
PosIniCam_value= [h_beam/2-cobrimento_beam, cobrimento_beam-h_beam/2, 0]
PosFinalCam_value = [h_beam/2-cobrimento_beam, cobrimento_beam-h_beam/2, 0]
